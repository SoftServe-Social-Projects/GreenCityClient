...
export class MatSnackBarComponent {
  ...
  snackType = {
    ...
    habitAcceptRequest: { classname: SnackbarClassName.success, key: 'snack-bar.error.habit-added-success' },
    habitDeclineRequest: { classname: SnackbarClassName.success, key: 'snack-bar.error.habit-decline-success' },
